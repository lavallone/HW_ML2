...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features: int, num_output_features: int) -> None:
        ...
        self.add_module("pool", nn.AvgPool2d(kernel_size=2, stride=2, ceil_mode=True)) # sempre problematico! --> ho dovuto impostare ceil_mode=True
...
# def _densenet(arch: str, growth_rate: int, block_config: Tuple[int, int, int, int], num_init_features: int, pretrained: bool, **kwargs: Any, ) -> DenseNet:
#     model = DenseNet(growth_rate, block_config, num_init_features, **kwargs)
#     return model


# def densenet121(pretrained: bool = False, **kwargs: Any) -> DenseNet:
#     return _densenet("densenet121", 32, (6, 12, 24, 16), 64, pretrained, **kwargs)


# def densenet161(pretrained: bool = False, **kwargs: Any) -> DenseNet:
#     return _densenet("densenet161", 48, (6, 12, 36, 24), 96, pretrained, **kwargs)


# def densenet169(pretrained: bool = False, **kwargs: Any) -> DenseNet:
#     return _densenet("densenet169", 32, (6, 12, 32, 32), 64, pretrained, **kwargs)


# def densenet201(pretrained: bool = False, **kwargs: Any) -> DenseNet:
