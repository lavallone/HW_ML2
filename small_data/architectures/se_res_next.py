...
class SEResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes):
        ...
        self.avgpool = nn.AvgPool2d(7, ceil_mode=True) # ho aggiunto ceil mode perchè dava problemi nel forward
    ...
    @staticmethod
    def get_classifiers():
        return ["se_resnet50", "se_resnet101", "se_resnet152"]
    
    @classmethod
    def build_classifier(cls, arch: str, num_classes: int, input_channels: int):
        _, type = arch.split("se_resnet")
        if type=='50':
...
class SEResNeXt(nn.Module):
    ...
    @staticmethod
    def get_classifiers():
        return ["se_resnext50", "se_resnext101", "se_resnext152"]
